...
class AktywacjaRecipe extends StatefulWidget {
  @override
  _AktywacjaRecipeState createState() => _AktywacjaRecipeState();
}

class _AktywacjaRecipeState extends State<AktywacjaRecipe>{
  ...
  Query refAktywacja = FirebaseDatabase.instance.ref('Przepisy_2').child('Aktywacja');
