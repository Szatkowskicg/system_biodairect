...
import 'package:system_biodairect/fitness_app/ui_view/scale_etap1_view.dart';
...
class MyDiaryEtap1 extends StatefulWidget {
  const MyDiaryEtap1({Key? key, this.animationController}) : super(key: key);

  final AnimationController? animationController;

  @override
  _MyDiaryEtap1State createState() => _MyDiaryEtap1State();
}

class _MyDiaryEtap1State extends State<MyDiaryEtap1>
  ...
  // int sumKcal = (kcalBreakfast + kcalSnack1 + kcalDiner + kcalSnack2 + kcalLunch);
  ...
  void addAllListData() {
    ...
    listViews.add(
      MealsListView(
        etapColor1: FitnessAppTheme.etap1,
        etapColor2: FitnessAppTheme.etap1_2,
