...
import 'package:system_biodairect/fitness_app/ui_view/wave_view.dart';
...
class WaterView extends StatefulWidget {
  const WaterView(
      {Key? key, this.mainScreenAnimationController, this.mainScreenAnimation, this.etapColor})
      : super(key: key);

  final Color? etapColor;
...
class _WaterViewState extends State<WaterView> with TickerProviderStateMixin {
  Future<bool> getData() async {
    ...
    refDailyInfo.onValue.listen((event) {
        DailyInfo dailyInfo = DailyInfo.fromMap(event.snapshot.value);
        setState(() {
          if (event.snapshot.value != null) {
            assert (dailyInfo.water != null);
            water = dailyInfo.water!;
          } else {
          }
        });
      });
                  ...
                  child: Row(
                    ...
                    Padding(
                        ...
                        child: Container(
                          ...
                          child: WaveView(
                            percentageValue: (water*100)/2500,
                            etapColor: widget.etapColor!,
                          ),
                        ),
                      )
                    ],
