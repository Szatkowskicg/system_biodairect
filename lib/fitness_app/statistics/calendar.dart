...
import 'package:system_biodairect/fitness_app/ui_view/statistics/calendar_view.dart';
import 'package:system_biodairect/fitness_app/ui_view/statistics/statistics_scale.dart';
import 'package:system_biodairect/fitness_app/ui_view/title_only_view.dart';
import '../fitness_app_theme.dart';

class CalendarHomeScreen extends StatefulWidget {
  const CalendarHomeScreen({Key? key, this.animationController, this.countDay}) : super(key: key);
...
class _CalendarHomeScreenState extends State<CalendarHomeScreen>
  ...
  Animation<double>? topBarAnimation, calendarAnimation, scaleBarAnimation;
  ...
  void initState() {
    ...
    calendarAnimation = Tween<double>(begin: 0.0, end: 1.0).animate(CurvedAnimation(
            parent: widget.animationController!,
            curve: Interval((1 / 2) * 0, 1.0, curve: Curves.fastOutSlowIn)));

    scaleBarAnimation = Tween<double>(begin: 0.0, end: 1.0).animate(CurvedAnimation(
            parent: widget.animationController!,
