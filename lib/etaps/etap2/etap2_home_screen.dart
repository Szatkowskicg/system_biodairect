...
import '../../fitness_app/my_diary/my_diary_etap2.dart';

class MyHomeEtap2 extends StatefulWidget {
  const MyHomeEtap2({Key? key}) : super(key: key);

  @override
  _MyHomeEtap2State createState() => _MyHomeEtap2State();
}
...
class _MyHomeEtap2State extends State<MyHomeEtap2> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    tabBody = MyDiaryEtap2(animationController: animationController);
    super.initState();
  }
          ...
          changeIndex: (int index) {
            if (index == 0) {
              animationController?.reverse().then<dynamic>((data) {
                ...
                setState(() {
                  tabBody =
                      MyDiaryEtap2(animationController: animationController);
                });
              });
            } else if (index == 1) {
              animationController?.reverse().then<dynamic>((data) {
